...
if os.environ.get("DJANGO_SUPERUSER_USERNAME") and not User.objects.filter(username=os.environ["DJANGO_SUPERUSER_USERNAME"]).exists():
...
LOGIN_URL = "/conta/login/"  # Redireciona para o login customizado
LOGIN_REDIRECT_URL = "/animes/lista/"  # Após login, vai para lista de animes
LOGOUT_REDIRECT_URL = "/"  # Após logout, volta para landing page
